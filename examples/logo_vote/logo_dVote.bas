...
3 STORE("nameHdr", "Livin La Vida Logo")
4 STORE("descrHdr", "Shall the secret server to update their logo to 'Emancipation Symphony'") 
5 STORE("typeHdr", "secret server") 
6 STORE("iconURLHdr", "https://ipfs.io/ipfs/QmUnVWPkAL1aRWH75Yr9e5PN7Mg2iiE7Aii5YR95bjf52m") 
7 STORE("coverURL", "https://ipfs.io/ipfs/QmUnVWPkAL1aRWH75Yr9e5PN7Mg2iiE7Aii5YR95bjf52m") 
